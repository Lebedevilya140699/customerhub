			...
			function (require, module, exports) {
				...
				module.exports = function (options) {
					var main = function () {
						...
						var parsedUserAgent = new UserAgentParser(
						...
						var browserLocale =
							window.navigator.language || window.navigator.userLanguage; // Everyone else, IE
						...
						var isBrowserOutOfDate = function () {
							...
							if (browserName === 'Edge') {
								browserMajorVersion =
									EDGEHTML_VS_EDGE_VERSIONS[browserMajorVersion];
							}
							...
							if (isBrowserUnsupported()) {
								...
								if (typeof minVersion == 'object') {
									...
									if (browserMajorVersion < minMajorVersion) {
										...
										var browserMinorVersion = parseMinorVersion(
